    ...
    const fetchData = async () => {
      try {
        const data = {
          ...
          avatar: { url: 'https://static1.squarespace.com/static/5be4ea9b55b02cf09b6748bd/5be9fe800ebbe885c5b76f3b/5e6e876d73af576a4f972d01/1587076876813/Bottle%252BLogo-Small.001_031820.jpg?format=1500w' },
          images: [
            { publicId: '1', version: '1', format: 'jpg', url: 'https://lh3.googleusercontent.com/p/AF1QipPoULIMZkHagDpD4kpnt3A40t8ZHP66GTzqE9K6=s1360-w1360-h1020' },
          ],
        };
        setShopData(data);
      } catch (error) {
...
return (
    <div className="shop-container">
      ...
      <p>Service Options: {shopData.serviceTypes?.join(' · ') || 'Not available'}</p>
      ...
      <a href={`/stores/${shopId}`} className="details-link">View Details</a>
